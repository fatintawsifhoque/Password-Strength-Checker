...
A clean, responsive, and real-time Password Strength Checker built with **Vue 3** and **Tailwind CSS**. 
...
- **Optimized Performance:** Uses Vue's `computed` properties to efficiently calculate individual regex checks, ensuring they only re-evaluate when the input changes.
...
- ⚡ **Vue 3** (Composition API, `<script setup>`, `ref`, `watch`, `computed`)
...
https://password-strength-checker-vue-fth.vercel.app
